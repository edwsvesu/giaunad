...
@section('javascript')
 ...
 <script>
     $(".btn-edit-idioma").click(function(){
        ...
        /*$("#input-idio-form").replaceWith("<div id='input-idio-form' class='form-group'><label class='control-label col-md-4 col-sm-4 col-xs-12'>Idioma</label><div class='col-md-4 col-sm-4 col-xs-12'><input type='text' value='"+$(this).data('idioma')+"' class='form-control col-md-7 col-xs-12' disabled></div></div>");*/
