            ...
            success: function(data){
                if(data){
                  ...
                  $('#datatable').DataTable().row.add([
                      nuevo_valor,
                      "<button class='btn btn-dark btn-xs btn-edit-tipo' value='"+tipo_proyecto_id+"' data-value='"+nuevo_valor+"' data-toggle='modal' data-target='#modal-form-tipo'><i class='fa fa-pencil'></i> Editar</button><button value='"+tipo_proyecto_id+"' data-toggle='modal' data-target='#modal-eliminar-tipo' class='btn btn-danger btn-xs btn-eliminar-tipo'><i class='fa fa-trash-o'></i> Borrar</button>"
          ...
          $.ajax({
            ...
            success: function(data){
                if(data){
                  $('#datatable').DataTable().row.add([
                      tipo_proyecto,
                      "<button class='btn btn-dark btn-xs btn-edit-tipo' value='"+data+"' data-value='"+tipo_proyecto+"' data-toggle='modal' data-target='#modal-form-tipo'><i class='fa fa-pencil'></i> Editar</button><button value='"+data+"' data-toggle='modal' data-target='#modal-eliminar-tipo' class='btn btn-danger btn-xs btn-eliminar-tipo'><i class='fa fa-trash-o'></i> Borrar</button>"
