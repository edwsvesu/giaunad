...
function ActivarEfectoCargaPagina(){
	$("#cargadorDePaginaPrincipal").css('display','flex');
}

function DesactivarEfectoCargaPagina(){
	$("#cargadorDePaginaPrincipal").css('display','none');
}
